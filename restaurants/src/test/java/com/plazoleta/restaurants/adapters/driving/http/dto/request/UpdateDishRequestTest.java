...
class UpdateDishRequestTest {
    ...
    void toString_ShouldReturnStringRepresentation() {
        // Given
        UpdateDishRequest request = new UpdateDishRequest(BigDecimal.valueOf(25.99), "Test description");
        ...
        assertTrue(result.contains("25.99") || result.contains("UpdateDishRequest"));
    }
    ...
    void equals_WhenEqualObjects_ShouldReturnTrue() {
        // Given
        UpdateDishRequest request1 = new UpdateDishRequest(BigDecimal.valueOf(25.99), "Test description");
        UpdateDishRequest request2 = new UpdateDishRequest(BigDecimal.valueOf(25.99), "Test description");
    ...
    void equals_WhenDifferentObjects_ShouldReturnFalse() {
        // Given
        UpdateDishRequest request1 = new UpdateDishRequest(BigDecimal.valueOf(25.99), "Test description");
        UpdateDishRequest request2 = new UpdateDishRequest(BigDecimal.valueOf(30.99), "Different description");
    ...
    void equals_WhenDifferentClass_ShouldReturnFalse() {
        // Given
        UpdateDishRequest request = new UpdateDishRequest(BigDecimal.valueOf(25.99), "Test description");
        String differentObject = "Not an UpdateDishRequest";
    ...
    @Test
    void hashCode_WhenEqualObjects_ShouldReturnSameHashCode() {
        // Given
        UpdateDishRequest request1 = new UpdateDishRequest(BigDecimal.valueOf(25.99), "Test description");
        UpdateDishRequest request2 = new UpdateDishRequest(BigDecimal.valueOf(25.99), "Test description");
    ...
    @Test
    void hashCode_WhenDifferentObjects_ShouldReturnDifferentHashCode() {
        // Given
        UpdateDishRequest request1 = new UpdateDishRequest(BigDecimal.valueOf(25.99), "Test description");
        UpdateDishRequest request2 = new UpdateDishRequest(BigDecimal.valueOf(30.99), "Different description");
